...
public interface PeopleApiCall {
    ...
    Observable<GenericResponse<ArrayList<PeopleList>>> getPeople(@Path("media") String mediaType, @Path("type") String type, @Query("api_key") String apiKey, @Query("page") int page);
}
